    ...
    <Wrapper className="background">
      <Form  onSubmit={(e) => handleSubmit(e)}>
        ...
        <Span>
          ...
          <Link to="/login" className="text-[#38BDF8] text-lg font-semibold hover:animate-pulse">
            Login
          </Link>
        </Span>

        <MdOutlineAccountTree className="absolute text-gray-400 mix-blend-overlay opacity-50 top-[50%] translate-y-[-50%] z-[-1]" size={200} />
      </Form>
    </Wrapper>
  );
};
...
const Heading = tw.div`py-2 px-4 text-4xl font-mono font-thin text-[#38BDF8] rounded-sm w-full text-center my-2 flex justify-center flex-col-reverse items-center gap-2
`;

const Form = tw.form`px-8 py-6 bg-[#1e242c] rounded-sm  shadow-xl flex flex-col gap-6 relative sm:w-[80%] sm:h-[90%] lg:w-[40%] lg:h-[90%] justify-start items-center border-2 border-gray-900 overflow-hidden
